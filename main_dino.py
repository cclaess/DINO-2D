...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--name_run', default='test_run', type=str)
    parser.add_argument('--arch', default='vit_small', type=str,
        choices=['vit_tiny', 'vit_small', 'vit_base'],
        help="""Name of architecture to train. For quick experiments with ViTs, we recommend using vit_tiny or 
        vit_small.""")
    ...
    parser.add_argument('--val_freq', default=1, type=int, help='Validate network every x epochs.')
...
def train_dino(args):
    ...
    transform = transforms.Compose([
        ...
        transforms.Orientation(as_closest_canonical=False),
    ...
    lr_schedule = utils.cosine_scheduler(
        args.lr * (args.batch_size_per_gpu * utils.get_world_size()) / 320.,  # linear scaling rule (256.)
        args.min_lr,
    ...
    momentum_schedule = utils.cosine_scheduler(args.momentum_teacher, 1, args.epochs, len(loader))
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, loader, optimizer,
...
class DataAugmentationDINO(object):
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number, seed=0):
        ...
        self.global_transform = transforms.Compose([
            transforms.RandRotate(range_x=math.pi * (15 / 180), prob=0.5, keep_size=True),
